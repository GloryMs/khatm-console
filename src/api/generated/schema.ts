...
export interface operations {
    ...
    bulkIssue: {
        ...
        responses: {
            ...
            /** @description The batch itself is invalid — empty items, or more than 200 (KH-CRD-0400); or the named schema requires attestation, which bulk issuance does not support (KH-ATT-0402, spec FS-2.4 item 2) — rejected wholesale before any item is processed */
            400: {
                headers: {
                    [name: string]: unknown;
                };
